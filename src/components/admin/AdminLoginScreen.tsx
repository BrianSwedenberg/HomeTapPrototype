  ...
  return (
    <div className="min-h-screen bg-bg-page flex items-center justify-center p-8">
      <div className="w-full max-w-[390px]">
        ...
        <div className="bg-bg-card rounded-lg shadow-card w-full" style={{ padding: '32px 28px' }}>

          {/* Logo */}
          <div className="flex justify-center mb-5">
            <svg width="120" height="28" viewBox="0 0 237 56" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <h1 className="text-[20px] font-bold text-text-primary text-center mb-[6px] tracking-[-0.3px]">
            Internal Admin Panel
          </h1>
          <p className="text-[13px] text-text-secondary text-center mb-6 leading-relaxed">
            Restricted access. Enter your admin password to continue.
          </p>

          <form onSubmit={handleSubmit}>
            <label className="block text-[13px] font-medium text-text-primary mb-[6px]">
              Admin Password
            </label>
            <input
              ref={inputRef}
              ...
              style={{
                width: '100%',
                border: `1.5px solid ${error ? '#C62828' : '#D0D0E0'}`,
                borderRadius: '10px',
                padding: '10px 12px',
                fontSize: '14px',
                color: '#1A1A2E',
            ...
            />
            {error && (
              <p style={{ color: '#C62828', fontSize: '12px', marginBottom: '14px' }}>
            ...
            <button
              ...
              onMouseEnter={e => (e.currentTarget.style.background = '#4E2D7A')}
